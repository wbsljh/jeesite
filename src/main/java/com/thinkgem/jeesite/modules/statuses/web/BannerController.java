...
import com.thinkgem.jeesite.modules.statuses.service.BannerService;
 ...
 */
@Controller
@RequestMapping(value = "${adminPath}/statuses/banner")
public class BannerController extends BaseController {
	...
	@RequiresPermissions("statuses:banner:view")
	...
	public String list(Banner banner, HttpServletRequest request, HttpServletResponse response, Model model) {
		...
		return "modules/statuses/bannerList";
	}
	...
	public String form(Banner banner, Model model) {
		...
		return "modules/statuses/bannerForm";
	}

	@RequiresPermissions("statuses:banner:edit")
	...
	public String save(Banner banner, Model model, RedirectAttributes redirectAttributes) {
		...
		addMessage(redirectAttributes, "保存首页条幅成功");
		return "redirect:"+Global.getAdminPath()+"/statuses/banner/?repage";
	}
	...
	public String delete(Banner banner, RedirectAttributes redirectAttributes) {
		...
		addMessage(redirectAttributes, "删除首页条幅成功");
		return "redirect:"+Global.getAdminPath()+"/statuses/banner/?repage";
	}
